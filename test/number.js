...
testSuite('numbers', function (assert) {
  ...
  testSuite('zero-fill right shift operator (>>>)', function () {
    assert('5 >>> 2', 5 >>> 2 === 1);
    assert('-5 >>> 2', -5 >>> 2 === 1073741822);
    assert('9 >>> 2', 9 >>> 2 === 2);
    assert('-9 >>> 2', -9 >>> 2 === 1073741821);
    assert('5.5 >>> 2.5', 5.5 >>> 2.5 === 1);
    assert('-5.5 >>> 2.5', -5.5 >>> 2.5 === 1073741822);
    assert('9.5 >>> 2.5', 9.5 >>> 2.5 === 2);
    assert('-9.5 >>> 2.5', -9.5 >>> 2.5 === 1073741821);
  });
});
